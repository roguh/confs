...
copy_confs_for git \
    bin/git-show-commits-not-in-branch.sh bin/gp bin/git-remote-status.sh bin/git-remove-branches-gone-in-remote.sh bin/git-push-new-branch.sh bin/gitdiff.sh .git-template/HEAD
